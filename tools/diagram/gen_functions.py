...
TOOLING = [
 ...
 ("switch", "the LOOP, keeping context healthy",
  "detect degradation, cut cheaply, resume with minimal ceremony —\ncontext optimal at all times, not just at a human boundary",
  "UNKNOWN. 'low' exists but was built for\ntoken budget, not context hygiene —\nand nothing detects degradation"),
