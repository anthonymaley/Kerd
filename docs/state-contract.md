...
**Owner:** dian (writes session plan), switch (writes session wrap-up)
...
**Readers:** switch (in), dian (orient), lorg (work signals), kivna out (decisions export)
**Committed:** yes
...
**Owner:** kivna save
**Readers:** switch (in), dian (orient), lorg (work signals), kivna out (status export)
