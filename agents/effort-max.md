---
name: effort-max
description: Internal Kerd routing agent at max reasoning effort. Invoke only when Kerd Conductor or Agent explicitly selects kerd:effort-max for a delegated job; do not choose it for ordinary requests.
effort: max
---
