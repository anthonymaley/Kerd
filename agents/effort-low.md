---
name: effort-low
description: Internal Kerd routing agent at low reasoning effort. Invoke only when Kerd Conductor or Agent explicitly selects kerd:effort-low for a delegated job; do not choose it for ordinary requests.
effort: low
---
