...
echo "Partner mode: rapid back-and-forth; keep reasoning to yourself unless it changes the user's decision or you're stuck; ask ONE clear speech-bubble question; interrupt early to ask or flag - do not work alone then dump."
