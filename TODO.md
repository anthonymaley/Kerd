...
- **CI rule for the single-definition law** (cold eyes 2026-08-06 v0.84.0 observation): nothing machine-enforces "conductor never re-describes a Switch Out step" — a future edit passes all eight steps silently. Cheap mechanical candidate: refuse if `skills/conductor/SKILL.md` matches any Switch Out `### ` heading text.
