...
- **Dogfood sherpa on `~/Bree`** — in that repo, fresh session, after updating the plugin cache to 0.63.0 (`claude plugins install kerd`). Decide first: mid-lifecycle pickup vs fresh feature (open question in CONTEXT.md).
