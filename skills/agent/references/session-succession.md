...
wording faithfully for display without editing the binding. Show it in the
arrival grid's TEAM cell: provider (role) + provider (role). IDs and routine notice status stay
